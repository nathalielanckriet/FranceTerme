...
public interface  Values {
    ...
    final static String id_attr = "id", statut_attr = "statut", categorie_attr = "categorie", origine_attr = "origine",
            langage_attr = "langage", langue_attr = "langue", href_attr = "href", type_attr = "type", privilegie_attr = "privilegie",
            url_attr = "url", antonyme_attr="antonyme", synonyme_attr="synonyme";
